...
<html lang="en">
  <head>
    ...
    <title>@yield('title') | Daftar Kepegawaian</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset('img/pg.jpg')}}" width="50px" alt="User Image">
        <div>
